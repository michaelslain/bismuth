...
**The design system lives OUTSIDE this repo**, at `~/Documents/dev/bismuth-design/` (a sibling checkout, not a submodule) — the ASCII spec the app was built to. Source comments citing `bismuth-design/ascii/…` resolve there. **Nothing in this repo imports it**: it was moved out because its prototype components sat beside the real ones, free to drift and easy to mistake for shipping code.
