...
// MUST be pointed at the real binary via the SDK's pathToClaudeCodeExecutable option. (Copy of
// core/src/claudeWhich.ts — kept here so the daemon workspace stays standalone.)
