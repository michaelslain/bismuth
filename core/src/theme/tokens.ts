...
export function semanticTokens(t: ColorTokens): SemanticTokens {
  return {
    danger: t.danger ?? (t.isLight ? SEMANTIC_LIGHT.danger : SEMANTIC_DARK.danger),
    success: t.success ?? (t.isLight ? SEMANTIC_LIGHT.success : SEMANTIC_DARK.success),
    warning: t.warning ?? (t.isLight ? SEMANTIC_LIGHT.warning : SEMANTIC_DARK.warning),
  };
}
