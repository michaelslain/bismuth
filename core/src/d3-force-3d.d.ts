...
declare module 'd3-force-3d' {
    ...
    export interface Simulation<N extends SimNode = SimNode> {
        ...
        on(
            typenames: string,
            listener: ((this: Simulation<N>) => void) | null,
        ): this
    ...
    export function forceX<N extends SimNode = SimNode>(
        x?: number | ((d: N, i: number, nodes: N[]) => number),
    ): PositionForce<N>
    export function forceY<N extends SimNode = SimNode>(
        y?: number | ((d: N, i: number, nodes: N[]) => number),
    ): PositionForce<N>
    export function forceZ<N extends SimNode = SimNode>(
        z?: number | ((d: N, i: number, nodes: N[]) => number),
    ): PositionForce<N>
}
