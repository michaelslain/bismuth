...
test('unknown link ids are skipped, and re-initialize does not double the force', () => {
    ...
    const f = linLogLinkForce<TN, { source: string; target: string }>(links, {
        id: n => n.id,
        strength: () => 1,
        dim: 3,
    })
