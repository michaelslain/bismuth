        ...
        inputSchema: {
            ...
            properties: {
                device: {
                    type: 'string',
                    description:
                        'Optional device id to claim as owner. Omit to just read the current owner.',
                },
            },
        },
    },
        ...
        inputSchema: {
            ...
            properties: {
                name: {
                    type: 'string',
                    description:
                        'Cron name (its file basename or frontmatter name).',
                },
            },
            required: ['name'],
        },
        ...
        inputSchema: {
            ...
            properties: {
                ...
                enabled: {
                    type: 'boolean',
                    description:
                        'true = enable (default), false = disable/pause.',
                },
            },
            required: ['name'],
        },
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                slug: {
                    type: 'string',
                    description: 'Page slug (its filename).',
                },
                title: { type: 'string', description: 'Optional page title.' },
                body: {
                    type: 'string',
                    description:
                        'Optional markdown body (the editable draft / question).',
                },
                actions: {
                    type: 'array',
                    description:
                ...
                source: {
                    type: 'string',
                    description:
                        "Optional provenance label, e.g. 'cron:answer-emails'.",
                },
                deliver_at: {
                    type: 'string',
                    description:
                        'Optional ISO instant to deliver at (omit = ASAP).',
                },
            },
            required: ['slug'],
        },
        ...
        inputSchema: {
            ...
            properties: {
                path: {
                    type: 'string',
                    description:
                        "The page's vault-relative path (from page_list), e.g. '.daemon/pages/foo.md'.",
                },
                action: {
                    type: 'string',
                    description: 'The action id to press.',
                },
            },
...
const DAEMON_TOOL_NAMES: ReadonlySet<string> = new Set(
    daemonTools.map(t => t.name),
)
