...
Source: `CLAUDE.md`, `package.json`, `app/package.json`, `app/scripts/dev.ts`, `app/scripts/devVault.ts`, `core/src/server.ts`, `core/src/settings.ts`, `core/src/daemonInstall.ts`, `app/scripts/build-daemon-sidecar.ts`, `app/vite.config.ts`, `app/src/api.ts`, `app/src-tauri/src/lib.rs`, `app/src-tauri/src/print_pdf.rs`, `app/src-tauri/tauri.conf.json`, `app/src/index.tsx`, `app/src/intro/VaultIntro.tsx`
