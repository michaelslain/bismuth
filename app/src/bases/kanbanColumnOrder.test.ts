...
describe('reorderColumnKeys', () => {
    test('moves a column to the front', () => {
        expect(reorderColumnKeys(KEYS, 'done', 'todo', false)).toEqual([
            'done',
            'todo',
            'doing',
        ])
    ...
    test('moves a column to the end', () => {
        expect(reorderColumnKeys(KEYS, 'todo', 'done', true)).toEqual([
            'doing',
            'done',
            'todo',
        ])
    ...
    test('moves a column into the middle (after the first)', () => {
        expect(reorderColumnKeys(KEYS, 'done', 'todo', true)).toEqual([
            'todo',
            'done',
            'doing',
        ])
    ...
    test("preserves the other columns' relative order", () => {
        const keys = ['a', 'b', 'c', 'd']
        expect(reorderColumnKeys(keys, 'a', 'c', true)).toEqual([
            'b',
            'c',
            'a',
            'd',
