...
export const Default: Story = {
  render: () => <BulletsView result={sampleViewResult()} config={sampleBaseConfig()} />,
};
...
export const Grouped: Story = {
  render: () => {
    const views = [{ type: "bullets" as const, name: "Bullets", groupBy: { property: "status" } }];
    return <BulletsView result={sampleViewResult(undefined, { views })} config={sampleBaseConfig({ views })} />;
  },
};
