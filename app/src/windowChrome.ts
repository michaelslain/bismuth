...
export function windowChromeOptions(isMac: boolean): { titleBarStyle: "overlay"; hiddenTitle: true } | { decorations: false } {
  return isMac ? { titleBarStyle: "overlay", hiddenTitle: true } : { decorations: false };
}
