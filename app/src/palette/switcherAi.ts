...
export const initialSwitcherAiState: SwitcherAiState = {
    phase: 'idle',
    gen: 0,
    results: [],
    error: null,
...
export function switcherAiReducer(
    state: SwitcherAiState,
    event: SwitcherAiEvent,
): SwitcherAiState {
    switch (event.type) {
        case 'ask':
            return {
