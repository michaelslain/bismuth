...
// string, so a plain path stays the tab/pane identity key) — both share createOneShotPathChannel.

import { createOneShotPathChannel } from './oneShotPathChannel'

const cursorChannel = createOneShotPathChannel<number>()
