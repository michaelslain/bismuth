...
const FILE_ROW_ITEMS: MenuItem[] = [
  ...
  { label: "Delete", icon: "Trash2", danger: true, separatorBefore: true, onSelect: noop },
];
...
export const Default: Story = {
  render: () => <ContextMenu x={140} y={90} items={FILE_ROW_ITEMS} onClose={noop} />,
};
...
export const WithQuickActionsAndDisabledRow: Story = {
  render: () => (
    <ContextMenu
      ...
      y={160}
      items={[
        { label: "Run now (already running)", icon: "Play", disabled: true, onSelect: noop },
        { label: "Disable", icon: "PowerOff", separatorBefore: true, onSelect: noop },
      ]}
