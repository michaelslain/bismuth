...
// searchResults.module.css's .sresult-count, and shell/CommandButton.module.css's .toolbar-badge each
...
/** A count riding inline inside a label, the way DaemonList's section heads and searchResults'
