...
export function SymbolGallery(props: Props) {
    ...
    onMount(() => {
        ...
        if (typeof requestAnimationFrame !== 'undefined')
            rafs.push(requestAnimationFrame(grab))
        ...
        const guardTimeout: ReturnType<typeof setTimeout> | 0 =
        ...
        onCleanup(() => {
            ...
            timeouts.forEach(t => {
                if (typeof clearTimeout !== 'undefined') clearTimeout(t)
            })
            if (guardTimeout && typeof clearTimeout !== 'undefined')
