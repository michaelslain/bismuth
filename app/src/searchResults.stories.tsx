...
const KEYWORD_RESULTS: SearchResult[] = [
  {
    ...
    matchCount: 2,
    snippets: [
      { line: 4, before: "Finished the ", match: "roadmap", after: " draft and sent it for review." },
      { line: 11, before: "Next week's ", match: "roadmap", after: " work starts with the API design." },
    ],
  },
  {
    path: "projects/Q3 Planning.md",
    matchCount: 1,
    snippets: [{ line: 22, before: "See the ", match: "roadmap", after: " note for the full timeline." }],
  },
];
...
const AI_RESULTS: SearchResult[] = [
  {
    ...
    snippets: [{ line: 3, before: "The ", match: "lease renewal", after: " deadline is September 1st." }],
  },
];
...
export const Empty: Story = {
  render: () => (
    <div style={{ width: "420px", color: "var(--faint)", "font-size": "13px" }}>
