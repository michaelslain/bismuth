    ...
    const view = new EditorView({
        ...
        state: EditorState.create({
            ...
            extensions: [
                ...
                ...(settings.editor.wrapSelection
                    ? [wrapSelection(() => settings.editor.wrapSelectionChars)]
                    : []),
                    ...
                    keymap.of([
                        {
                            ...
                            run: v => {
                                ...
                                queueMicrotask(() => h.onNav('next'))
                                return true
                            },
                            shift: () => {
                                queueMicrotask(() => h.onNav('prev'))
                                return true
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            run: v => {
                                if (completionStatus(v.state) != null)
                                    return false // completion keymap accepts the option (#49)
                                ...
                                if (LIST_OR_QUOTE_LINE.test(line.text))
                                    return false // in a list → enterKeymap continues it
