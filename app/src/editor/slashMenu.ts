...
export function matchSlashPrefix(
    textBefore: string,
...
export const SLASH_ITEMS: SlashItem[] = [
    ...
    },
    {
        ...
        label: 'Callout',
        icon: 'Megaphone',
        info: 'Obsidian-style admonition callout.',
        keywords: [
            'callout',
            'admonition',
            'note',
    ...
    },
    {
        ...
        keywords: ['code', 'fence', 'codeblock', 'snippet'],
        snippet: '```\n$0\n```',
    },
    {
        id: 'query',
        label: 'Query block',
        icon: 'Database',
        info: 'Embedded base / query block.',
    ...
    },
    {
        ...
        label: 'Graph block',
        icon: 'Share2',
        info: 'Embedded editable graph (nodes + edges).',
        keywords: ['graph', 'diagram', 'nodes', 'edges', 'network', 'mindmap'],
        snippet: '```graph\n$0\n```',
    },
    {
        id: 'math',
    ...
    // strips comments) via bases/markdown.ts so the page-break survives into the rendered HTML.
    {
        ...
        info: 'Forces a new page in PDF export.',
        keywords: ['page', 'break', 'pagebreak', 'pdf', 'print'],
        snippet: '<!-- pagebreak -->\n$0',
    },
    {
        id: 'wikilink',
        label: 'Link to note',
        icon: 'Link',
        info: 'Insert a [[wikilink]].',
        keywords: ['link', 'wikilink', 'internal', 'ref', 'note'],
        snippet: '[[$0]]',
        reTrigger: true,
    },
    {
        ...
        label: 'Embed',
        icon: 'Image',
        info: 'Embed a note, image, or file.',
        keywords: ['embed', 'image', 'attachment', 'file', 'transclude'],
        snippet: '![[$0]]',
        reTrigger: true,
    },
    {
        ...
        label: 'Properties',
        icon: 'FileText',
        info: 'Add a frontmatter / properties block (top of the note).',
        keywords: [
            'properties',
            'frontmatter',
            'yaml',
