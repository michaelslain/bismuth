...
export const OverlappingEvents: Story = {
  render: () => {
    ...
    seedCalendarState({
      ...
      events: [
        { id: "ov-1", title: "Sync with design", date: day, startTime: "10:00", endTime: "11:00", category: "Work" },
        { id: "ov-2", title: "1:1 with manager", date: day, startTime: "10:15", endTime: "10:45", category: "Personal" },
        { id: "ov-3", title: "Focus block", date: day, startTime: "10:30", endTime: "12:00", category: "Focus" },
      ],
    });
    return (
      <div class="calendar-app" style={{ height: "80vh" }}>
