...
export const CategoryColors: Story = {
  render: () => {
    seedCalendarState({
      ...
      events: [
        { id: "cc-1", title: "Standup", date: "2026-01-12", startTime: "09:00", endTime: "09:15", category: "Work" },
        { id: "cc-2", title: "Dentist", date: "2026-01-13", startTime: "15:00", endTime: "16:00", category: "Personal" },
        { id: "cc-3", title: "Team offsite", date: "2026-01-14", startTime: "10:00", endTime: "16:00", category: "Work", categories: ["Work", "Focus"] },
      ],
    });
    return (
      <div class="calendar-app" style={{ height: "80vh" }}>
