 ...
 *  the bottom of its parent instead of sitting content-sized with a blank void below (D4). */
export const FillsParent: Story = {
    ...
    play: async ({ canvasElement }) => {
        ...
        // would sit well above the parent's, leaving the blank void D4 describes.
