...
const GLYPHS: Record<string, string> = {
  ...
  // Everything else: sensible glyph per name, grouped roughly by kind.
  AppWindow: "▭", Archive: "▣", ArchiveX: "▣x",
  ArrowDown: "↓", ArrowLeft: "←", ArrowRight: "→", ArrowUp: "↑",
  AtSign: "@", Ban: "⊘", Blend: "◐", Bold: "B",
  Book: "▥", BookOpen: "▥", Box: "▢", Brain: "❋", BrainCircuit: "❋", Bug: "†",
  CaseSensitive: "Aa", ChartColumn: "▇", ChartLine: "⤳",
  Check: "✓", CircleCheck: "✓", CircleHelp: "?", CircleX: "⊗",
  ChevronDown: "▾", ChevronLeft: "‹", ChevronRight: "▸", ChevronUp: "▴",
  Clipboard: "▧", ClipboardList: "▧", Code: "{}", Columns2: "‖", Columns3: "▩",
  Combine: "∪", Copy: "❐", Crown: "★",
  Database: "▥", Download: "↓",
  Eraser: "⌫", Eye: "◉", ExternalLink: "↗",
  File: "▯", FilePlus: "▯+", Flame: "‡",
  FolderInput: "▸→", FolderPlus: "▸+",
  Gauge: "◐", Globe: "○", Grid3x3: "▦",
  Hash: "#", Heading1: "H1", Heading2: "H2", Heading3: "H3", Heart: "♥", Highlighter: "▐",
  Image: "▧", ImagePlus: "▧+", Info: "i", Italic: "I",
  KeyRound: "○", Landmark: "▲", Layers: "▦", LayoutGrid: "▦", LayoutList: "☰",
  Lightbulb: "✦", Link: "∞", List: "☰", ListChecks: "☑", ListOrdered: "☰", Lock: "▣",
  Map: "▧", Megaphone: "‡", Menu: "☰", Minus: "-", Network: "◇", Notebook: "▥",
  Palette: "◐",
  PanelBottom: "▁", PanelLeft: "<<", PanelRight: ">>",
  Pen: "✎", Pencil: "✎", PenTool: "✎", Pin: "◆", PinOff: "◇", Play: "▶",
  Plus: "+", Power: "⏻", PowerOff: "⏻",
  Redo2: "↻", RefreshCw: "↻", Regex: ".*", Repeat: "↻", Replace: "⇄", Reply: "↩",
  RotateCcw: "↺", Scissors: "✂", Search: "/", Send: "→",
  SeparatorHorizontal: "—", Settings: "*", Share: "⤳",
  Sigma: "Σ", Smile: "☺", Sparkles: "✦",
  Square: "□", SquareCheck: "☑", SquareKanban: "▥", SquarePlus: "□+", SquareSlash: "⊘",
  SquareTerminal: ">_", SquareX: "⊠", Star: "★",
  Tag: "#", TextQuote: "❝", Trash2: "⌫", TriangleAlert: "△",
  Undo2: "↺", Ungroup: "⊟", Users: "∴", Vote: "☑",
  WholeWord: "[W]", Wrench: "⚙", X: "x", Zap: "‡", ZoomIn: "+", ZoomOut: "-",
};
