...
function unwrap<T>(m: any): T {
    return (
        m && m.default && typeof m.default === 'object' ? m.default : m
    ) as T
}
const emojilib = unwrap<Record<string, string[]>>(await import('emojilib'))
const byEmoji = unwrap<
    Record<string, { name: string; slug: string; group?: string }>
...
const SPECIAL_CHARS: { char: string; name: string; keywords: string[] }[] = [
    // arrows
    {
        char: '→',
        name: 'arrow_right',
        keywords: ['arrow', 'right', 'rightwards'],
    },
    ...
    { char: '↓', name: 'arrow_down', keywords: ['arrow', 'down', 'downwards'] },
    {
        ...
        keywords: ['arrow', 'leftright', 'horizontal'],
    },
    {
        char: '↕',
        name: 'arrow_up_down',
        keywords: ['arrow', 'updown', 'vertical'],
    },
    {
        char: '⇒',
        name: 'double_arrow_right',
        keywords: ['arrow', 'implies', 'then', 'right'],
    },
    {
        char: '⇐',
        name: 'double_arrow_left',
        keywords: ['arrow', 'left', 'double'],
    },
    {
        char: '⇔',
        name: 'double_arrow_left_right',
    ...
    // typographic
    {
        char: '—',
        name: 'emdash',
        keywords: ['em', 'dash', 'hyphen', 'punctuation', 'long'],
    },
    {
        char: '–',
        name: 'endash',
        keywords: ['en', 'dash', 'hyphen', 'range', 'punctuation'],
    },
    {
        char: '…',
        name: 'ellipsis',
        keywords: ['dots', 'ellipsis', 'etc', 'horizontal'],
    },
    {
        char: '“',
        name: 'ldquo',
        keywords: ['left', 'double', 'quote', 'curly', 'smart'],
    },
    {
        char: '”',
        name: 'rdquo',
        keywords: ['right', 'double', 'quote', 'curly', 'smart'],
    },
    {
        char: '‘',
        name: 'lsquo',
        keywords: ['left', 'single', 'quote', 'curly', 'apostrophe'],
    },
    {
        char: '’',
        name: 'rsquo',
        keywords: ['right', 'single', 'quote', 'curly', 'apostrophe'],
    },
    {
        char: '«',
        name: 'laquo',
        keywords: ['left', 'guillemet', 'angle', 'quote'],
    },
    {
        char: '»',
        name: 'raquo',
        keywords: ['right', 'guillemet', 'angle', 'quote'],
    },
    ...
    { char: '†', name: 'dagger', keywords: ['dagger', 'cross', 'footnote'] },
    {
        char: '‡',
        name: 'double_dagger',
        keywords: ['dagger', 'double', 'footnote'],
    },
    { char: '©', name: 'copyright', keywords: ['copyright', 'legal', 'c'] },
    {
        char: '®',
        name: 'registered',
        keywords: ['registered', 'trademark', 'legal', 'r'],
    },
    ...
    // math
    {
        char: '±',
        name: 'plus_minus',
        keywords: ['plus', 'minus', 'plusminus', 'tolerance'],
    },
    {
        char: '×',
        name: 'times',
        keywords: ['times', 'multiply', 'multiplication', 'cross', 'x'],
    },
    ...
    },
    {
        char: '≠',
        name: 'not_equal',
        keywords: ['not', 'equal', 'unequal', 'ne'],
    },
    {
        char: '≡',
        name: 'identical',
        keywords: ['identical', 'equivalent', 'congruent'],
    },
    {
        char: '≤',
        name: 'less_equal',
        keywords: ['less', 'than', 'equal', 'lte'],
    },
    {
        char: '≥',
        name: 'greater_equal',
        keywords: ['greater', 'than', 'equal', 'gte'],
    },
    {
        char: '∞',
        name: 'infinity',
        keywords: ['infinity', 'infinite', 'forever'],
    },
    {
        char: '√',
        name: 'sqrt',
    ...
    },
    {
        char: '∑',
        name: 'sum',
        keywords: ['sum', 'sigma', 'summation', 'total'],
    },
    ...
    { char: '∫', name: 'integral', keywords: ['integral', 'calculus'] },
    {
        char: '∂',
        name: 'partial',
        keywords: ['partial', 'derivative', 'calculus'],
    },
    {
        char: '∆',
        name: 'delta',
    ...
    { char: 'µ', name: 'micro', keywords: ['micro', 'mu', 'micron'] },
    {
        char: '∈',
        name: 'element_of',
        keywords: ['element', 'member', 'in', 'set'],
    },
    {
        char: '∉',
        name: 'not_element_of',
        keywords: ['not', 'element', 'member', 'set'],
    },
    ...
    { char: '∅', name: 'empty_set', keywords: ['empty', 'set', 'null'] },
    {
        char: '∩',
        name: 'intersection',
        keywords: ['intersection', 'and', 'cap', 'set'],
    },
    ...
    // checks / marks
    {
        char: '✓',
        name: 'check',
        keywords: ['check', 'tick', 'yes', 'done', 'correct'],
    },
    {
        char: '✔',
        name: 'heavy_check',
        keywords: ['check', 'tick', 'yes', 'done', 'bold'],
    },
    {
        char: '✗',
        name: 'cross_mark',
        keywords: ['cross', 'x', 'no', 'wrong', 'incorrect'],
    },
    {
        char: '✘',
        name: 'heavy_cross',
        keywords: ['cross', 'x', 'no', 'wrong', 'bold'],
    },
    {
        char: '☑',
        name: 'ballot_check',
        keywords: ['checkbox', 'checked', 'ballot', 'done'],
    },
    {
        char: '☐',
        name: 'ballot_empty',
        keywords: ['checkbox', 'empty', 'ballot', 'todo'],
    },
    {
        char: '★',
        name: 'star_filled',
        keywords: ['star', 'filled', 'favorite', 'rating'],
    },
    {
        char: '☆',
        name: 'star_empty',
        keywords: ['star', 'empty', 'outline', 'rating'],
    },
    // currency
    { char: '€', name: 'euro', keywords: ['euro', 'currency', 'money', 'eur'] },
    {
        char: '£',
        name: 'pound',
        keywords: ['pound', 'sterling', 'currency', 'money', 'gbp'],
    },
    {
        char: '¥',
        name: 'yen',
        keywords: ['yen', 'yuan', 'currency', 'money', 'jpy', 'cny'],
    },
    {
        char: '¢',
        name: 'cent',
        keywords: ['cent', 'currency', 'money', 'penny'],
    },
    {
        char: '₿',
        name: 'bitcoin',
        keywords: ['bitcoin', 'btc', 'crypto', 'currency', 'money'],
    },
    {
        char: '₹',
        name: 'rupee',
        keywords: ['rupee', 'currency', 'money', 'inr', 'india'],
    },
    // misc
    {
        char: '≅',
        name: 'congruent',
        keywords: ['congruent', 'approximately', 'equal'],
    },
    { char: '∝', name: 'proportional', keywords: ['proportional', 'varies'] },
    {
        char: '⊕',
        name: 'circled_plus',
        keywords: ['xor', 'plus', 'circled', 'direct', 'sum'],
    },
    {
        char: '⊗',
        name: 'circled_times',
        keywords: ['tensor', 'times', 'circled', 'product'],
    },
]
...
const specialEntries: EmojiEntry[] = SPECIAL_CHARS.map(s => ({
    ...
    name: s.name,
    keywords: dedupe(
        [s.name, s.name.replace(/_/g, ' '), ...s.keywords].map(kw),
    ),
}))
