// The CSS Color Module named-colour keyword set, used by checks.mjs's hardcodedColor check
// to spot literal colour words (e.g. `color: red`) that should be token references instead.
